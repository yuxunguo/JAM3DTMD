...
conf['params']['transversity']['u b0 1'] ={'value':    4.5e+00, 'min': 3.55, 'max':15.0, 'fixed': False}
...
conf['params']['transversity']['d b0 1'] ={'value':    7.5e+00,    'min': 6.55, 'max':15.0, 'fixed': False}
...
#Sivers function
conf['params']['sivers']={}
conf['params']['sivers']['widths1_uv']  ={'value':    2.22698e-01, 'min':0, 'max':1, 'fixed': False}
conf['params']['sivers']['widths1_dv']  ={'value':    2.22698e-01, 'min':0, 'max':1, 'fixed': 'widths1_uv'}
...
conf['params']['sivers']['u N0 1'] ={'value':   -1.65486e-01, 'min': -10.0, 'max': 10.0, 'fixed': False}
conf['params']['sivers']['u N1 1'] ={'value':    0.00000e+00, 'min': -10.0, 'max': 1.0, 'fixed': True}
conf['params']['sivers']['u a0 1'] ={'value':   -1.31882e-01, 'min':-2.0, 'max':10.0, 'fixed': False}
conf['params']['sivers']['u a1 1'] ={'value':    0.00000e+00, 'min':-2.0, 'max':10.0, 'fixed': True}
conf['params']['sivers']['u b0 1'] ={'value':    4.44664e+00, 'min': 3.55, 'max':10.0, 'fixed': False}
...
conf['params']['sivers']['d N0 1'] ={'value':    1.15863e-01, 'min': -20.0, 'max': 10.0, 'fixed': False}
conf['params']['sivers']['d N1 1'] ={'value':    0.00000e+00, 'min': 0.0, 'max': 1.0, 'fixed': 'u N1 1'}
conf['params']['sivers']['d a0 1'] ={'value':   -4.28964e-01, 'min':-2.0, 'max':10.0, 'fixed': False}
conf['params']['sivers']['d a1 1'] ={'value':    0.00000e+00, 'min':-2.0, 'max':10.0, 'fixed': 'u a1 1'}
conf['params']['sivers']['d b0 1'] ={'value':    6.55000e+00, 'min': 6.55, 'max':10.0, 'fixed': False}
