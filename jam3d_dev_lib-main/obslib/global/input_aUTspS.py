...
conf['params']['transversity']['widths1_uv']  ={'value':    6.36914e-01, 'min':0, 'max':1, 'fixed': True}
...
conf['params']['transversity']['widths2_uv']  ={'value':    1.50864e-02, 'min':0, 'max':1, 'fixed': True}
...
conf['params']['transversity']['u N0 1'] ={'value':    9.24040e+00, 'min': -10.0, 'max': 10.0, 'fixed': True}
conf['params']['transversity']['u N1 1'] ={'value':   -4.75538e-01, 'min': -10.0, 'max': 1.0, 'fixed': True}
conf['params']['transversity']['u a0 1'] ={'value':    4.91144e-01, 'min':-2.0, 'max':10.0, 'fixed': True}
conf['params']['transversity']['u a1 1'] ={'value':    7.25593e-02, 'min':-2.0, 'max':10.0, 'fixed': True}
conf['params']['transversity']['u b0 1'] ={'value':    2.72459e+00, 'min': 0.0, 'max':10.0, 'fixed': True}
conf['params']['transversity']['u b1 1'] ={'value':    1.31194e+00, 'min': 0.0, 'max':10.0, 'fixed': True}
...
conf['params']['transversity']['d N0 1'] ={'value':   -2.28339e+01, 'min': -100.0, 'max': 100.0, 'fixed': True}
conf['params']['transversity']['d N1 1'] ={'value':   -4.75538e-01, 'min': 0.0, 'max': 1.0, 'fixed': 'u N1 1'}
conf['params']['transversity']['d a0 1'] ={'value':    1.68378e+00, 'min':-2.0, 'max':10.0, 'fixed': True}
conf['params']['transversity']['d a1 1'] ={'value':    7.25593e-02, 'min':-2.0, 'max':10.0, 'fixed': 'u a1 1'}
conf['params']['transversity']['d b0 1'] ={'value':    4.24694e+00, 'min': 0.0, 'max':10.0, 'fixed': True}
...
#
#conf['params']['collinspi']['widths1_fav']   ={'value':    7.61783e-02,'min':0, 'max':1, 'fixed':False}
#conf['params']['collinspi']['widths1_ufav'] ={'value':    9.00093e-01,'min':0, 'max':1, 'fixed':False}
...
#
#conf['params']['collinspi']['u N0 1'] ={'value':    1.52997e+00,'min': -15, 'max': 2, 'fixed':False}
#conf['params']['collinspi']['u N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':True}
#conf['params']['collinspi']['u a0 1'] ={'value':   -1.40151e+00,'min':-2.5, 'max': 5, 'fixed':False}
#conf['params']['collinspi']['u a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5, 'fixed':True}
#conf['params']['collinspi']['u b0 1'] ={'value':    5.59824e+00,'min': 0, 'max':10, 'fixed':False}
...
#conf['params']['collinspi']['u N0 2'] ={'value':    4.26057e-01,'min': -15, 'max': 15, 'fixed':False}
#conf['params']['collinspi']['u N1 2'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':True}
#conf['params']['collinspi']['u a0 2'] ={'value':    2.23550e-02,'min':-2, 'max': 20, 'fixed':False}
#conf['params']['collinspi']['u a1 2'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':True}
#conf['params']['collinspi']['u b0 2'] ={'value':    1.46108e+00,'min': 0, 'max':10, 'fixed':False}
...
#
#conf['params']['collinspi']['d N0 1'] ={'value':   -2.34941e+00,'min': -10, 'max': 10, 'fixed':False}
#conf['params']['collinspi']['d N1 1'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':True}
#conf['params']['collinspi']['d a0 1'] ={'value':    1.69206e+00,'min':-2, 'max': 2, 'fixed':False}
#conf['params']['collinspi']['d a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':True}
#conf['params']['collinspi']['d b0 1'] ={'value':    4.11112e+00,'min': 0, 'max':10, 'fixed':False}
...
#
#conf['params']['collinspi']['s N0 1'] ={'value':   -2.34941e+00,'min': 0, 'max': 1, 'fixed':'d N0 1'}
#conf['params']['collinspi']['s N1 1'] ={'value':    0.00000e+00,'min': 0, 'max': 1, 'fixed':'d N1 1'}
#conf['params']['collinspi']['s a0 1'] ={'value':    1.69206e+00,'min':-2, 'max': 2, 'fixed':'d a0 1'}
#conf['params']['collinspi']['s a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 2, 'fixed':'d a1 1'}
#conf['params']['collinspi']['s b0 1'] ={'value':    4.11112e+00,'min': 0, 'max':10, 'fixed':'d b0 1'}
...
#
#
#conf['params']['collinspi']['ub N0 1'] ={'value':   -2.34941e+00,'min': -15, 'max': 2,  'fixed':'d N0 1'}
#conf['params']['collinspi']['ub N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'d N1 1'}
#conf['params']['collinspi']['ub a0 1'] ={'value':    1.69206e+00,'min':-2.5, 'max': 5,  'fixed':'d a0 1'}
#conf['params']['collinspi']['ub a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'d a1 1'}
#conf['params']['collinspi']['ub b0 1'] ={'value':    4.11112e+00,'min': 0, 'max':10,    'fixed':'d b0 1'}
...
#
#conf['params']['collinspi']['db N0 1'] ={'value':    1.52997e+00,'min': -15, 'max': 2,  'fixed':'u N0 1'}
#conf['params']['collinspi']['db N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'u N1 1'}
#conf['params']['collinspi']['db a0 1'] ={'value':   -1.40151e+00,'min':-2.5, 'max': 5,  'fixed':'u a0 1'}
#conf['params']['collinspi']['db a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'u a1 1'}
#conf['params']['collinspi']['db b0 1'] ={'value':    5.59824e+00,'min': 0, 'max':10,    'fixed':'u b0 1'}
...
#conf['params']['collinspi']['db N0 2'] ={'value':    4.26057e-01,'min': -10, 'max': 10, 'fixed':'u N0 2'}
#conf['params']['collinspi']['db N1 2'] ={'value':    0.00000e+00,'min': 0, 'max': 1,    'fixed':'u N1 2'}
#conf['params']['collinspi']['db a0 2'] ={'value':    2.23550e-02,'min':-2, 'max': 20,   'fixed':'u a0 2'}
#conf['params']['collinspi']['db a1 2'] ={'value':    0.00000e+00,'min':-2, 'max': 2,    'fixed':'u a1 2'}
#conf['params']['collinspi']['db b0 2'] ={'value':    1.46108e+00,'min': 0, 'max':10,    'fixed':'u b0 2'}
...
#
#conf['params']['collinspi']['sb N0 1'] ={'value':   -2.34941e+00,'min': -15, 'max': 2,  'fixed':'d N0 1'}
#conf['params']['collinspi']['sb N1 1'] ={'value':    0.00000e+00,'min': -10, 'max': 10, 'fixed':'d N1 1'}
#conf['params']['collinspi']['sb a0 1'] ={'value':    1.69206e+00,'min':-2.5, 'max': 5,  'fixed':'d a0 1'}
#conf['params']['collinspi']['sb a1 1'] ={'value':    0.00000e+00,'min':-2, 'max': 5,    'fixed':'d a1 1'}
#conf['params']['collinspi']['sb b0 1'] ={'value':    4.11112e+00,'min': 0, 'max':10,    'fixed':'d b0 1'}
...
conf['params']['Htildepi']['u N0 1'] ={'value':   -3.91413e+00,'min': -15, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['u N1 1'] ={'value':   -5.34771e-03,'min': -10, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['u a0 1'] ={'value':    4.63818e+00,'min':-2, 'max': 5, 'fixed':False}
conf['params']['Htildepi']['u a1 1'] ={'value':   -6.35748e-04,'min':-2, 'max': 5, 'fixed':False}
conf['params']['Htildepi']['u b0 1'] ={'value':    1.47825e+00,'min': 0, 'max':10, 'fixed':False}
conf['params']['Htildepi']['u b1 1'] ={'value':    1.17996e-02,'min': 0, 'max':10, 'fixed':False}
...
conf['params']['Htildepi']['d N0 1'] ={'value':    3.10148e+00,'min': -10, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['d N1 1'] ={'value':   -5.34771e-03,'min': 0, 'max': 1, 'fixed':'u N1 1'}
conf['params']['Htildepi']['d a0 1'] ={'value':    2.59000e+00,'min':-2, 'max': 10, 'fixed':False}
conf['params']['Htildepi']['d a1 1'] ={'value':   -6.35748e-04,'min':-2, 'max': 2, 'fixed':'u a1 1'}
conf['params']['Htildepi']['d b0 1'] ={'value':    1.62098e+00,'min': 0, 'max':10, 'fixed':False}
conf['params']['Htildepi']['d b1 1'] ={'value':    1.17996e-02,'min': 0, 'max':10, 'fixed':'u b1 1'}
...
conf['params']['Htildepi']['s N0 1'] ={'value':    3.10148e+00,'min': 0, 'max': 1, 'fixed':'d N0 1'}
conf['params']['Htildepi']['s N1 1'] ={'value':   -5.34771e-03,'min': 0, 'max': 1, 'fixed':'d N1 1'}
conf['params']['Htildepi']['s a0 1'] ={'value':    2.59000e+00,'min':-2, 'max': 2, 'fixed':'d a0 1'}
conf['params']['Htildepi']['s a1 1'] ={'value':   -6.35748e-04,'min':-2, 'max': 2, 'fixed':'d a1 1'}
conf['params']['Htildepi']['s b0 1'] ={'value':    1.62098e+00,'min': 0, 'max':10, 'fixed':'d b0 1'}
conf['params']['Htildepi']['s b1 1'] ={'value':    1.17996e-02,'min': 0, 'max':10, 'fixed':'d b1 1'}
...
conf['params']['Htildepi']['ub N0 1'] ={'value':    3.10148e+00,'min': -15, 'max': 2,  'fixed':'d N0 1'}
conf['params']['Htildepi']['ub N1 1'] ={'value':   -5.34771e-03,'min': -10, 'max': 10, 'fixed':'d N1 1'}
conf['params']['Htildepi']['ub a0 1'] ={'value':    2.59000e+00,'min':-2.5, 'max': 5,  'fixed':'d a0 1'}
conf['params']['Htildepi']['ub a1 1'] ={'value':   -6.35748e-04,'min':-2, 'max': 5,    'fixed':'d a1 1'}
conf['params']['Htildepi']['ub b0 1'] ={'value':    1.62098e+00,'min': 0, 'max':10,    'fixed':'d b0 1'}
conf['params']['Htildepi']['ub b1 1'] ={'value':    1.17996e-02,'min': 0, 'max':10,    'fixed':'d b1 1'}
...
conf['params']['Htildepi']['db N0 1'] ={'value':   -3.91413e+00,'min': -15, 'max': 2,  'fixed':'u N0 1'}
conf['params']['Htildepi']['db N1 1'] ={'value':   -5.34771e-03,'min': -10, 'max': 10, 'fixed':'u N1 1'}
conf['params']['Htildepi']['db a0 1'] ={'value':    4.63818e+00,'min':-2.5, 'max': 5,  'fixed':'u a0 1'}
conf['params']['Htildepi']['db a1 1'] ={'value':   -6.35748e-04,'min':-2, 'max': 5,    'fixed':'u a1 1'}
conf['params']['Htildepi']['db b0 1'] ={'value':    1.47825e+00,'min': 0, 'max':10,    'fixed':'u b0 1'}
conf['params']['Htildepi']['db b1 1'] ={'value':    1.17996e-02,'min': 0, 'max':10,    'fixed':'u b1 1'}
...
conf['params']['Htildepi']['sb N0 1'] ={'value':    3.10148e+00,'min': -15, 'max': 2,  'fixed':'d N0 1'}
conf['params']['Htildepi']['sb N1 1'] ={'value':   -5.34771e-03,'min': -10, 'max': 10, 'fixed':'d N1 1'}
conf['params']['Htildepi']['sb a0 1'] ={'value':    2.59000e+00,'min':-2.5, 'max': 5,  'fixed':'d a0 1'}
conf['params']['Htildepi']['sb a1 1'] ={'value':   -6.35748e-04,'min':-2, 'max': 5,    'fixed':'d a1 1'}
conf['params']['Htildepi']['sb b0 1'] ={'value':    1.62098e+00,'min': 0, 'max':10,    'fixed':'d b0 1'}
conf['params']['Htildepi']['sb b1 1'] ={'value':    1.17996e-02,'min': 0, 'max':10,    'fixed':'d b1 1'}
