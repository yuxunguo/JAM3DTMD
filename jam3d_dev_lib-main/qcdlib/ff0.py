...
class FF(CORE):
    ...
    def __init__(self,hadron):
        ...
        self.setup()
        if   hadron=='pi': 
            self.ff = INTERPOLATOR('dsspipLO_0000')
            #self.ff = INTERPOLATOR('JAM22-FF_pion_nlo_0000')
            #self.ff = INTERPOLATOR('JAM20-SIDIS_FF_pion_nlo_0000')
        elif hadron=='k':  
            self.ff = INTERPOLATOR('dssKpLO_0000')
            #self.ff = INTERPOLATOR('JAM22-FF_kaon_nlo_0000')
            #self.ff = INTERPOLATOR('JAM20-SIDIS_FF_kaon_nlo_0000')
        elif hadron=='h':
            self.ffpi = INTERPOLATOR('dsspipLO_0000')
            self.ffk = INTERPOLATOR('dssKpLO_0000')
            #self.ffpi = INTERPOLATOR('JAM22-FF_pion_nlo_0000')
            #self.ffk = INTERPOLATOR('JAM22-FF_kaon_nlo_0000')
            #self.ffpi = INTERPOLATOR('JAM20-SIDIS_FF_pion_nlo_0000')
            #self.ffk = INTERPOLATOR('JAM20-SIDIS_FF_kaon_nlo_0000')
