...
conf['params']['pdf']={}
conf['params']['pdf']['widths1_uv']  ={'value':    5.65394e-01,'min': 0,'max':1,'fixed':False}
conf['params']['pdf']['widths1_dv']  ={'value':    6.01982e-01,'min': 0,'max':1,'fixed':False}
conf['params']['pdf']['widths1_sea'] ={'value':   -6.19623e-01,'min': 0,'max':1,'fixed':False}
...
conf['params']['ffpi']={}
conf['params']['ffpi']['widths1_fav']  ={'value':    1.16836e-01,'min': 0,'max':1,'fixed':False}
conf['params']['ffpi']['widths1_ufav'] ={'value':   -1.36697e-01,'min': 0,'max':1,'fixed':False}
...
conf['params']['ffk']={}
conf['params']['ffk']['widths1_fav']  ={'value':    1.32455e-01,'min': 0,'max':1,'fixed':False}
conf['params']['ffk']['widths1_ufav'] ={'value':    1.85629e-01,'min': 0,'max':1,'fixed':False}
